        ...
        return (
          <section className="nav">
            <section id="news-subnav" onMouseLeave={this.hideNav} className="news-subnav">
              <a href="http://47.93.28.215/vr/news/school/" className="subnav-item" id="subnav-item1">
              ...
              <a href="http://47.93.28.215/vr/news/industry/" className="subnav-item" id="subnav-item2">
                <div className="mask"></div>
