            ...
            <section className="home">
                ...
                <section className="news-middle-box">
                    <section className="news-middle-content-box">
                        <PicText data="/static/image/news/banner1.jpg" title="全球首个VR软件视保技术发布-微视酷致力打造健康VR教育" type="2" href="http://www.duckr.cn" />
                        <PicText data="/static/image/news/banner2.jpg" title="Vive生态圈大会在深举行，VR教育再成热点！" type="2" href="http://www.baidu.com" />
                    </section>
                </section>
                <section className="news-fotter-box1">
                        <PicText data="/static/image/news/banner3.png" title="济南VR智慧课堂教育研讨会大获成功，引发广泛关注" type="3" href="http://www.duckr.cn" />
                        <PicText data="/static/image/news/banner4.jpg" title="江苏新沂市教育局召开VR智慧课堂研讨会" type="3" href="http://www.baidu.com" />
                        <PicText data="/static/image/news/banner5.jpg" title="微视酷落地常熟探讨VR教学" type="3" href="http://www.duckr.cn" />
                </section>
                <section className="news-fotter-box2">
                        <PicText data="/static/image/news/banner6.png" title="微视酷VR课堂亮相北京小学英语信息化课堂教学研讨会" type="3" href="http://www.duckr.cn" />
