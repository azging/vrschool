            ...
            <section className="home">
                ...
                <section className="news-middle-box">
                    <section className="news-middle-content-box">
                        <PicText data="http://download.duckr.cn/vrschool/industry/banner1.png" title="几年后才有真正的虚拟现实？" type="2" href="http://www.duckr.cn" />
                        <PicText data="http://download.duckr.cn/vrschool/industry/banner2.png" title="微软公布华硕的新头显和戴尔的新设计" type="2" href="http://www.baidu.com" />
                    </section>
                </section>
                <section className="news-fotter-box1">
                        <PicText data="http://download.duckr.cn/vrschool/industry/banner3.png" title="沉浸的艺术 细数全球四类虚拟现实软件" type="3" href="http://www.duckr.cn" />
                        <PicText data="http://download.duckr.cn/vrschool/industry/banner4.png" title="虚拟现实(VR)：下一个时代的开启？" type="3" href="http://www.baidu.com" />
                        <PicText data="http://download.duckr.cn/vrschool/industry/banner5.png" title="虚拟现实和增强现实 谁才是未来？" type="3" href="http://www.duckr.cn" />
                </section>
                <section className="news-fotter-box2">
                        <PicText data="http://download.duckr.cn/vrschool/industry/banner6.jpg" title="中国的ARVR产业链已经做到世界级" type="3" href="http://www.duckr.cn" />
